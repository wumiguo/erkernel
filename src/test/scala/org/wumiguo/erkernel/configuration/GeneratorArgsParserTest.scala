...
class GeneratorArgsParserTest extends AnyFlatSpec {
  it should "parse args" in {
    val args = Array("-execId", "001", "-appConfPath", "application.yml",
      "-kernelConfPath", "erKernel.yml", "-dataSourcesDir", "pipelineDataSources.json",
      "-vertexOutputDir", "./data")
    ...
    assertResult(result.vertexOutputDir)("./data")
  }
}
